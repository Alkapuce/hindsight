...
description: "Add long-term memory to Vercel Eve agents with Hindsight's memory provider. Scoped recall before each turn, automatic capture after — no model tool-calling."
---
